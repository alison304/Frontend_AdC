                  ...
                  <div className='right-side'>
                    ...
                    >
                      <Link style={{ color: 'inherit' }} to="/login">
                        <MenuItem onClick={handleCloseUser}>Hola Usuario</MenuItem>
                      </Link>
                      <Link style={{ color: 'inherit' }} to="/register">
                        <MenuItem onClick={handleCloseUser}>Cerrar Sesión</MenuItem>
                      </Link>
                    </Menu>
                  </div>
                </>
...
export default Navbar_logueado